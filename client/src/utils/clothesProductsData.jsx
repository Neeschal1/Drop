export const Data = [
  {
    women: [
      ...
      },
      {
        ...
        description:
          "Utility-inspired wide-leg cargo pants featuring multiple pockets and a comfortable high-rise waist.",
        image1:
      ...
      },
      {
        ...
        description:
          "Minimal everyday mini skirt featuring a flattering silhouette and easy-to-style design.",
        image1:
    ...
    men: [
      ...
      },
      {
        ...
        description:
          "Modern knitted polo featuring a refined collar and relaxed silhouette for elevated everyday dressing.",
        image1:
